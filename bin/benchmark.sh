...
./target/release/pipeline solve "$file_path" knn lkh -n 11 -d "./.vrp/$file_name/min_c" > "./.vrp/$file_name/min_c.txt"
echo "Solved LKH min cluster [11]"
...
./target/release/pipeline solve "$file_path" knn lkh -n 9 -d "./.vrp/$file_name/fixed_c_size" > "./.vrp/$file_name/fixed_c_size.txt"
echo "Solved LKH ~15 cluster size [9]"
...
./target/release/pipeline solve "$file_path" knn direct -n 16 -d "./.vrp/$file_name/direct" > "./.vrp/$file_name/direct.txt"
echo "Solved direct"
